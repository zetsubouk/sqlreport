...
当前版本：v0.9.0（2026-09-03）｜技术栈：Python 3 标准库（http.server / sqlite3），零新依赖

> **实施计划**：v0.4 → v0.7 的详细实施（决策表 D1-D10、22 个 Task、TDD 步骤与完整代码）见
> [`docs/PLAN-v0.4-v0.7.md`](docs/PLAN-v0.4-v0.7.md)。
> 里程碑进度：✅ v0.4 统计基础 → ✅ v0.5 交叉分析 → ✅ v0.6 对比与维度 → ✅ v0.7 交付加固（xlsx/token/分组）→ ✅ v0.8 编辑器与预览体验 → ✅ v0.9 版本基线（无新功能）。
